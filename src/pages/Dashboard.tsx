      ...
      `}>
        ...
        <nav className="flex flex-col gap-2 overflow-y-auto pr-2">
          ...
          <button 
            ...
            className={`flex items-center justify-between p-3 rounded-lg transition-all text-slate-600 hover:bg-slate-100 mb-2`}
          >
          ...
          {user?.role === 'admin' && (
            <button 
              ...
              className={`flex items-center justify-between p-3 rounded-lg transition-all text-slate-600 hover:bg-slate-100 mt-2`}
            >
              <div className="flex items-center gap-3">
                <Layers size={18} />
          ...
          <button 
            ...
            className={`flex items-center justify-between p-3 rounded-lg transition-all text-slate-600 hover:bg-slate-100 mt-auto`}
          >
            <div className="flex items-center gap-3">
              <User size={18} />
              <span>Perfil</span>
              ...
              <div>
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all appearance-none"
                    required
                  >
